...
from mycode.auth import auth as authmod
...
from mycode.util.error import NamedError
...
async def _discover_providers() -> dict[str, ProviderInfo]:
    ...
    # Falls back to cwd so that mycode.json in the project root is discovered.
    cfg = configmod.get(directory=os.getcwd())

    # Step 0: Load models.dev database and seed providers with models
    from mycode.provider import models_dev
