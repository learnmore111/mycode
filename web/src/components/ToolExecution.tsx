...
import { ChevronDown, ChevronRight, Loader2, CheckCircle2, XCircle, Circle } from 'lucide-react'
...
export default function ToolExecution({ part }: Props) {
  ...
  const statusBg = () => {
    switch (status) {
      case 'running': return 'bg-status-warning-light border-status-warning/15'
      case 'completed': case 'success': return 'bg-status-success-light border-status-success/15'
      case 'error': return 'bg-status-error-light border-status-error/15'
